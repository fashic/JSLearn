...
/* harmony import */ var _services_DataService_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
...
function () {
  function App(_ref) {
    ...
    _services_DataService_js__WEBPACK_IMPORTED_MODULE_3__["DataService"].getCurrencies().then(function (data) {
      _this._data = data;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(App, [{
    key: "_tradeItem",
    value: function _tradeItem(id, amount) {
    ...
    value: function _initTable() {
      ...
      this._table = new _index_js__WEBPACK_IMPORTED_MODULE_2__["Table"]({
        data: this._data,
    ...
    value: function _initFilter() {
      ...
      this._filter = new _index_js__WEBPACK_IMPORTED_MODULE_2__["Filter"]({
        element: this._el.querySelector("[data-element=filter]")
      });

      this._filter.on('filter', function (e) {
        var filterValue = e.detail;
        _services_DataService_js__WEBPACK_IMPORTED_MODULE_3__["DataService"].getCurrencies({
          filter: filterValue
        }).then(function (data) {
          _this3._table.update(data);
        });
      });
    }
  }, {
    ...
    value: function _initPortfolio() {
      this._portfolio = new _index_js__WEBPACK_IMPORTED_MODULE_2__["Portfolio"]({
    ...
    value: function _initTradeWidget() {
      ...
      this._tradeWidget = new _index_js__WEBPACK_IMPORTED_MODULE_2__["TradeWidget"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Table_Table_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Table", function() { return _Table_Table_js__WEBPACK_IMPORTED_MODULE_0__["Table"]; });

/* harmony import */ var _Portfolio_Portfolio_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Portfolio", function() { return _Portfolio_Portfolio_js__WEBPACK_IMPORTED_MODULE_1__["Portfolio"]; });

/* harmony import */ var _TradeWidget_TradeWidget_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TradeWidget", function() { return _TradeWidget_TradeWidget_js__WEBPACK_IMPORTED_MODULE_2__["TradeWidget"]; });

/* harmony import */ var _Filter_Filter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Filter", function() { return _Filter_Filter_js__WEBPACK_IMPORTED_MODULE_3__["Filter"]; });
...
/* harmony import */ var _Component_Component_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
  ...
  function TradeWidget(_ref) {
    ...
    _this._el.addEventListener("click", function (e) {
      ...
      if (e.target.closest('[data-action="btn-buy"]')) {
        ...
        _this._el.dispatchEvent(buyEvent); // this._buyInfo(e);
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _HttpService_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19);
...
var DataService = {
  getCurrencies: function getCurrencies() {
    var query,
        ...
        data,
        _args = arguments;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.async(function getCurrencies$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            promise = _HttpService_js__WEBPACK_IMPORTED_MODULE_3__["HttpService"].sendRequest(COINS_URL);
            filter = query.filter;
            _context.prev = 3;
            _context.next = 6;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.awrap(promise);
          ...
          case 6:
            ...
            return _context.abrupt("return", DataService.getCurrenciesPrice(data)["catch"](function (err) {
  ...
  getCurrenciesPrice: function getCurrenciesPrice(data, callback) {
    var coinsUrls = data.map(function (coin) {
      return getSingleCoinUrl(coin.id);
    });
    return _HttpService_js__WEBPACK_IMPORTED_MODULE_3__["HttpService"].sendMultipleRequests(coinsUrls).then(function (coins) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MyPromise, [{
    ...
    value: function then(successCallback) {
      ...
      if (this._status === "fulfilled") {
        ...
        this._successCallback.push(successCallback); // this._errorCallback.push(errorCallback);
    ...
    value: function _resolve(data) {
      ...
      this._successCallback.forEach(function (callback) {
    ...
    value: function _reject(error) {
      ...
      this._errorCallback.forEach(function (callback) {
